...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        function initCrop(fileName){
            $('.example').html('<div class="example"><div class="default"><div class="cropMain" style="width:1200px; height:660px;"></div> <div class="cropGallery"></div> <button class="cropButton cropInCustomer">Crop and Save</button></div></div>').show();
               ...
               // display canvas image
                   ...
                   $.ajax({
                           ...
                           data: { 
                               ...
                               path:'gallery/main_images/'
                           }
                   })
                   .done(function(responseJSON) {
                        if(responseJSON.success){
                            $('.loadIconSml').remove;
                            $('#imgrounded').attr('src', '/gallery/main_images/' + responseJSON.fileName);
