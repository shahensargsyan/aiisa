        ...
        var uploader = new qq.FileUploader({
            ...
            onComplete: function(id, fileName, responseJSON){
                ...
                if(responseJSON.success == true){
                    ...
                    $('#img' + count).html('<div class="forCropArea"><div class="forCropPlugin" id="crop_container' + count + '"></div><div id="crop' + count + '" class="upbtn cropSave">Crop And Save</div><input type="hidden" name="pic[picture' + count + ']" value="' + responseJSON.fileName + '" /></div>');
