<div class="regform span5 margauto">
    ...
    <div class="control-group" id="Individual" hidden>
        ...
        ?> <br>       
        <div class="control-group">
            <label class="control-label" >Individual Description</label>
            <div class="controls">
    ...
    <div class="control-group contractFld">
        ...
        echo $this->Form->input('contract_id', array('multiple' => 'checkbox', 'options' => $options,'label' => FALSE),array('class'=>'checkbox'));
        ?>          
    </div>
...
<script>
    $(document).ready(function(){
        $(function() {
            ...
            if(type==''){
                $('div.checkbox').children('input').attr('disabled','disabled');
            }
