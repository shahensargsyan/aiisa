<div class="span5 margauto">
    ...
    <div class="maskDiv text-center">        
        <img id="defaultBackground" src="/system/site/nocategory.png" class="mainimg"style="width:227px;height:232px" />
    </div>
    <?php
...
<script>
    $(document).ready(function(){
        $('#category_id').val($("#select").val());
        $('#select').change(function(){
            var id = $(this).val();
            $('#category_id').val(id);
        });
        
        if($("#select :selected").text() == "Choose category"){
