...
<div class="span5 margauto">
    ...
    <div class="maskDiv text-center"> 
        ...
        if($Category['image'] != NULL && file_exists(WWW_ROOT . 'system/site/' . $Category['image'])){
            echo '<img style="width:947px;" src="/system/site/' . $Category['image'] . '" id="defaultBackground" class="mainimg">';
        }else{
            echo '<img style="width:947px;" src="/system/site/menu.jpg" id="defaultBackground" class="mainimg">';
        }
        ?>
    </div>
    <?php
