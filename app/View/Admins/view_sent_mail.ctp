<div id="success"></div>
  ...
  <div class="messageBox">
   ...
   <?php if($message['Contactus']['reply'] != '-'):?>
   <div class="messageSection registerUser">
		<div class="leftSide">Replied</div>
		<div class="rightSide" style="width:320px !important;">
			<?php echo $message['Contactus']['reply'];?></div>	  
   </div>
   <?php endif;?>
	<?php /*
   ...
   <div>
   		<?php echo $this->Form->create('Reply');
			  echo $this->Form->input('id',array('type' => 'hidden','value' => $message['Contact']['id']));?>
   		<div class="toSection registerUser">
			<div class="leftSide">To</div>
			<div class="rightSide" style="width:320px !important;">
			<?php echo $this->Form->input('to',array('label' => false,'size' => 54,'value' => $message['Contact']['emailId']));?>
			</div>	  
  		 </div>
