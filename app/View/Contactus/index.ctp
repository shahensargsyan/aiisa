...
<div id="banner">
    ...
    <div class="popup uboutUsPopup">
        ...
        <div class="popupHeader contact-page contact">
            ...
            <p class=" abouttext">We always love to hear from our community. Please share with us any thoughts, suggestions or queries that you may have.</p>
            ...
            <!--<form action="" class="contact">-->
                ...
                <div class="contactControls">
                    <label class='abouttext'>Your Message:</label>
                    <?php echo $this->Form->textarea('question',array('placeholder' => "Type your message here:",'label' => false,'required'=>'required','class'=>'mInput ta contactTa','id' => 'comment'));?>
