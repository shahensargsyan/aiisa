<div class="span5 ">
    <h3 class="text-center">Edit Expert Comments</h3>
    <hr class="separator">
    ...
    <div class="control-group">
        <label class="control-label">Photo by</label>
        <?php
        echo $this->Form->input(
                'photo_by', array(
                    'type' => 'text',
...
<!--    <div class="control-group">
    ...
    <div>
        <img src="/system/expertComments/<?php echo $photo; ?>" id="imgrounded" />
    </div>
    ...
    <div class="control-group btnSection">
        ...
        ?>
        <?php echo $this->Html->link('Cancel', array('controller' => 'experts', 'action' => 'expertComments'), array('class' => 'btn'));
        ?>
        </div>
    </div>
</div>
               ...
               // display canvas image
                   ...
                   $.ajax({
                          ...
                          data: { 
                                ...
                                path:'system/expertComments/'
                           }
                   })
                   .done(function(responseJSON) {
                        if(responseJSON.success){
                            $('.loadIconSml').remove;
                            $('#imgrounded').attr('src', '/system/expertComments/' + responseJSON.fileName);
