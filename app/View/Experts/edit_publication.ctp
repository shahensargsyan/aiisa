...
<!--    <div class="control-group">
    ...
    <div>
        <img src="/system/publications/<?php echo $photo; ?>" id="imgrounded" />
    </div>
    ...
    <div class="control-group btnSection">
        ...
        ?>
        <?php echo $this->Html->link('Cancel', array('controller' => 'experts', 'action' => 'publications'), array('class' => 'btn'));
        ?>
        </div>
    </div>
</div>
               ...
               // display canvas image
                   ...
                   .done(function(responseJSON) {
                        if(responseJSON.success){
                            $('.loadIconSml').remove;
                            $('#imgrounded').attr('src', '/system/publications/' + responseJSON.fileName);
