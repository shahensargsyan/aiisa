...
<div class="timer">
  <div class="timer_div_left">
  	<div class="minute_wrapper">
		...
		<span class="med_now_image"><?php echo $this->Html->image('map/green.png'); ?></span>
	</div>
    <?php if($num_online_users > 1){?>
		<div class="minute_wrapper">
			Users Online: <?php echo $num_online_users+11; ?>
		</div>
	<?php }?>
		...
		<div class="middle-midd-boxcont">
			...
			<div class="paggingOverlay" style="display:none" id="paging-indicator"><?php echo $this->Html->image('ajax-loader.gif'); ?></div>
						...
						foreach($meditating_now as $list):?>
 							<div class="middle-midd-box">
								<div class="middle-midd-boxinner">
									...
									<?php 
											$profile_picture 	= ($list['User']['profile_picture']!='')?'../profileimg/'.$list['User']['profile_picture']:'guest_avatar.png';
									...
									<div class="session_features userCommentsList">
										...
										<div class="img">
										<?php $profile_picture 	= ($userMeta['User']['profile_picture']!='')?'../profileimg/'.$userMeta['User']['profile_picture']:'guest_avatar.png'; echo $this->Html->image($profile_picture, array('style' => 'border:none;float:left;','width'=>'33','height'=>'28')); ?> 
										</div>
										...
										<div id="img">
										<?php 
										$profile_picture 	= ($comment['User']['profile_picture']!='')?'../profileimg/'.$comment['User']['profile_picture']:'../profileimg/guest_avatar.png';
				...
				<div class="hidden" id="meditating_near_me_list">
						...
						<div class="middle-midd-boxinner">
						<div class="middle-midd-boxinner-imgleft">
							<?php $profile_picture 	= ($list['User']['profile_picture']!='')?'../profileimg/'.$list['User']['profile_picture']:'guest_avatar.png';
								echo $this->Html->image($profile_picture, array('style' => 'border:none;','width'=>'80','height'=>'88')); ?>
						</div>
						<div class="middle-midd-boxinner-right">
							<div class="middle-midd-boxinner-right-info">
						...
						<div style="float:left;">
						<div class="img">
						<?php $profile_picture 	= ($userMeta['User']['profile_picture']!='')?'../profileimg/'.$userMeta['User']['profile_picture']:'guest_avatar.png';
				...
				<div class="hidden" id="finished_meditating_list">
					...
					<div style="float:left;">
					<div class="img">
					<?php		$profile_picture 	= ($userProfile[0]['User']['profile_picture']!='')?'../profileimg/'.$userProfile[0]['User']['profile_picture']:'guest_avatar.png';
					...
					*/
					...
					<div id="img">
					<?php 
					$profile_picture 	= ($comment['User']['profile_picture']!='')?'../profileimg/'.$comment['User']['profile_picture']:'guest_avatar.png';
					echo $this->Html->image($profile_picture, array('style' => 'border:none;float:left;margin: 7px 0 0 1px;','width'=>'33','height'=>'28')); ?>
					</div>
					<div id="personCommented"><?php echo $comment['User']['first_name']." ".$comment['User']['last_name'];?></div>
					<div class="comment"><?php echo $comment['comment'];?></div>
...
<div id="popup_1" class="blank_wrapper1">
	...
	<div class="popup_1_container">
		<div class="login_popup">
			<div style="padding:5px 20px 20px"><div id="back_to_popup_first" class="close_button"><?php echo $this->Html->image('close.gif') ?></div></div>
		...
		<div class="timer_wrapper">
			...
			<?php if(!empty($userMeta['Usersmeta']['setsessions'])){ ?>
				<div class="timer_container">
					...
					<div id="back_to_popup1" class="close_button"><?php echo $this->Html->image('close.gif') ?></div>
	...
	<div class="popup_3_container" style="display:none;">
		...
		<div id="div_popup" class="timer_form_container">
			...
			<div class="timer_counter_container">
				...
				<div class="smiles_container">
					...
					echo $this->Html->link($this->Html->image('smile_normal.gif'), 'javascript:void(0);', array('id'=>'4', 'alt'=>'Normal Smile', 'title'=>'Normal Smile', 'border'=>'0', 'onClick'=>'meditationRating(4);', 'escape' => false));
					echo $this->Html->link($this->Html->image('smile_indifferent.gif'), 'javascript:void(0);', array('id'=>'3', 'alt'=>'Indifferent', 'title'=>'Indifferent', 'border'=>'0', 'onClick'=>'meditationRating(3);', 'escape' => false));
					echo $this->Html->link($this->Html->image('smile_confused.gif'), 'javascript:void(0);', array('id'=>'2', 'alt'=>'Not Happy', 'title'=>'Not Happy', 'border'=>'0', 'onClick'=>'meditationRating(2);', 'escape' => false));
					echo $this->Html->link($this->Html->image('smile_frown.gif'), 'javascript:void(0);', array('id'=>'1', 'alt'=>'Frown', 'title'=>'Frown', 'border'=>'0', 'onClick'=>'meditationRating(1);', 'escape' => false));	
					?>
		...
		<!-- CUSTOM MEDITATION TIMER -->
			<div class="meditation-stop-watch timer_form_container">
				...
				<div class="timer_container">
					<span id="back_to_popup1" class="close_button"><?php echo $this->Html->image('close.gif') ?></span>
				...
				<div class="timer_counter_container">
					...
					********************/
					...
					echo $this->Form->text('customTotalMedTime', array('value'=>'', 'id'=>'customTotalMedTime'));
