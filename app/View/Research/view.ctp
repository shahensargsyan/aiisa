...
function loadPiece(href,divName) {
    jQuery(divName).load(href, {}, function(){
        ...
        jQuery(divPaginationLinks).click(function(event) {
...
jQuery(document).ready(function() {
    loadPiece("<?php echo  $this->Html->url(array('controller'=>'research','action'=>'latest',$type,$id));?>","#latest"); 
    loadPiece("<?php echo  $this->Html->url(array('controller'=>'research','action'=>'experts',$type,$id));?>","#expert_comment"); 
    loadPiece("<?php echo  $this->Html->url(array('controller'=>'research','action'=>'publications',$type,$id));?>","#research_publications"); 
    loadPiece("<?php echo  $this->Html->url(array('controller'=>'research','action'=>'past_events',$type,$id));?>","#past_events"); 
    loadPiece("<?php echo  $this->Html->url(array('controller'=>'research','action'=>'videos',$type,$id));?>","#videos"); 
    jQuery( "#tabs" ).tabs();
}); 
</script>
<div class="row">
    <header class="page-content-level page-content-header">
        <div class="breadcrumb">
            ...
            <!--<span class="breadcrumb-link breadcrumb-depth-1 breadcrumb-odd breadcrumb-last">Global Health</span>-->
        </div>
        <div class="tabs"></div>
    </header>
    <section class="page-content-level column page-content-main section_index_region" id="page-content-main">
        <header class="page-content-container main-title" id="main-title">
            <h1 class="has-content-alongside"><?php echo $title; ?></h1>
        </header>
