    ...
    <div class="popup loginPopup ">
        ...
        <div class="popupHeader">
            ...
            <div id="loginButtons">
                ...
                <?php echo $this->Form->submit('LOGIN', array('formnovalidate' => true, 'div' => false, 'class' => 'lButton greenbtn-login  bfirst', 'id' => 'enterLogin')); ?>
                <a href="/" class="lButton cancel-btn">CANCEL</a>
            ...
            <div id="lFooter">
                <div id="lLinks">
                    <div class="row">
                        ...
                        <div class="right">
                            <p> <?php echo $this->Html->link('Sign Up Here', array('controller' => 'users','action' => 'register'), array('class' => 'green aboutUsLink', 'id' => 'signUp')); ?></p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="left">
                        ...
                        <div class="right">
                            <p><?php echo $this->Html->link('Click Here ', 'forgetpassword', array('class' => 'green aboutUsLink', 'id' => 'forgetpassword')); ?></p>
                        </div>
                    </div>
                </div>

                <div id="lIcons">
                    <div class="signin-using">Or Sign In Using:</div>
