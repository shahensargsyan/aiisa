...
<div id="banner">
    ...
    <div class="popup dashboardPopup" id="pp">
        ...
        <div id="popup_right">
            ...
            <div id="dashContent">
                <div id="meButtons">
<!--            <div class="meditating_tab" id="meditating_near_me_tab">Set Session</div>
                    <div class="meditating_tab selected" id="meditating_now_tab">My Meditation </div>-->
                    <a href="#" class="outline_btn btnGreen" id="meditating_now_tab">MY MEDITATION</a>
