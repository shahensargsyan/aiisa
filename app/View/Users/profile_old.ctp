...
<!--                                <div>
                    ...
                    <div id="mMiddle">
                        ...
                        <div id="mBottom">
                            <div class="leftControls dashControlWrapL">
                                <label>City:</label>
                                <?php echo $this->Form->input('city', array('readonly'=>'readonly','value'=>$city, 'label' => false,'class'=>'login','id'=>'city')); ?>
...
<!--                            <a href="#" class="white_btn mBtn">EDIT PROFILE</a>
		...
		<?php echo $this->Html->link($this->Form->input('Save', array('formnovalidate' => true,'div'=>false,'label' => false, 'type'=>'button', 'class'=>'white_btn mBtn', 'id' =>'saveProfile')),'/users/editprofile', array('escape'=>false));?>
                <?php echo $this->Form->button('Cancel',array('class'=>'outline_btn mBtn cancel-btn','div'=>false,'id'=>'cancel-edit-profile'));?>
