    ...
    <div id="msLastTable">
                ...
                if($totalUserSession >=1){
                    for($i=0;$i<$totalUserSession;$i++){
                       ...
                       // echo'<div class="packet_left">';
                        ...
                        echo '<td>';
                        echo $this->Html->link("Edit",array('controller' => 'usersmetas', 'action' => 'editsession',$explode_session[0],$explode_session[1],$explode_session[2],$explode_session[3]),array('class' => 'outline_btn')).'&nbsp;&nbsp;';
            ...
            ?>
                                                ...
                                                <div id="msBellSound" class=leftControls>
                                                    ...
                                                    <p>Your Bell Sound: <strong>ring.mp3</strong>
                                                    </p>
                                                </div>
