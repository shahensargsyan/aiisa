...
function initOpenClose() {
	jQuery('.language-area').openClose({
		activeClass: 'active',
		opener: '.opener',
		slider: '.slide',
		animSpeed: 400,
...
;(function($){
	$.fn.contentTabs = function(o){
		...
		return this.each(function(){
			...
			tabLinks.each(function(){
				...
				if(options.attrib === 'href') {
					link.bind('click', function(e){
						if(typeof options.stopMove === 'function'){
							options.stopMove(options);
						}
						e.preventDefault();
					});
				}
			...
			function autoRotate() {
				//if(typeof options.stopMove === 'function') return;
